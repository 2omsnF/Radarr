...
import { align, icons, kinds, scrollDirections, sortDirections } from 'Helpers/Props';
...
function getScrollDirection(view) {
  if (view === 'table') {
    return scrollDirections.BOTH;
  }
...
class MovieIndex extends Component {
  ...
  render() {
    ...
    const scrollDirection = getScrollDirection(view);
